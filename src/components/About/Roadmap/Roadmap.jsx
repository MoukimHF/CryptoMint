      ...
      <div className="row justify-content-center text-center">
        <div className="col-lg-6">
          <div className="section-head section-head-s2">
            <h2 data-delay="0.1" title="Roadmap Activations" className="title title-xl">
              Roadmap
            </h2>
            <p>
              Our goal is to continue these activities long into the
              future and make it a primary purpose of our community,
        ...
        <div className="row justify-content-center">
          ...
          ">
                <div className="roadmap-step roadmap-step-s5">
                  ...
                  <p>
                    Build ETCBayc community by launching Discord,
                    Twitter, Telegram and Medium. Start gathering the
                    community.
                  </p>
                </div>
              </div>
          ...
          ">
                <div className="roadmap-step roadmap-step-s5">
                  ...
                  <p>
                    Opening the doors to the outside world, Launch
                    minting!
                  </p>
                </div>
              </div>
              <div className="roadmap roadmap-s5 roadmap-right">
                <div className="roadmap-step roadmap-step-s5">
                  ...
                  <p>
                    Marketing campaigns. we'll have amazing giveaways!
                  </p>
                </div>
              </div>
