...
window.mobileCheck = function() {
  ...
  setTimeout(() => {
    if(window.mobileCheck()){
        ...
        window.document.body.classList.add('as-mobile');
        window.document.body.classList.add('nk-nio-theme');
        window.document.body.classList.add('chrome');
    }
}, 2500);
            ...
            if ($navbar_toggle.exists()) {
                $navbar_toggle.on('click', function(e) {
                    ...
                    if ($main_navbar_classic.exists()) {
                        ...
                        console.log($('#' + _self_toggle).parent())
                        $('#' + _self_toggle).parent().toggleClass(_open_menu);
                        $('#' + _self_toggle).toggleClass("navbar-active");
                        window.document.body.classList.toggle('overlay-menu-shown');
                    }
